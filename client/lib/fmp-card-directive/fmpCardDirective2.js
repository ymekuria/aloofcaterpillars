angular.module('fmp-card2', [])
    .directive("fmpCard2", function($timeout, $window) {
        ...
        var animateCardMovingIn = function(smallCard, largeCard, flipCard, transitionSpeed) {
            ...
            largeCard.largeCardWidthSize = smallCard.clientWidth * 100;
            largeCard.largeCardHeightSize = smallCard.clientHeight * 100;
